...
router.register('regjionet', views.RegjionetView)
...
router.register('shitja', views.ShitjaViewCheck)
# router.register('ulsetregjion', views.UlsetRegjionView.as_view())

urlpatterns = [
    path('', include(router.urls)),
    path('shitjet/', views.ShitjaView.as_view(), name="shitjet"),
    path('ulsetregjion/', views.UlsetRegjionView.as_view(), name="instances"),
    path('ulsetupdate/', views.UlsetUpdateStatus.as_view(), name="ulsetupdate"),
    path('inserttickets/', views.ShitjaInsertView.as_view(), name="inserttickets"),
